...
class Post(Base):
    ...
    def __repr__(self) -> str:
        return (
            f'Post(id = {self.id!r}, text={self.text!r}, pub_date={self.pub_date}'
            f'author_id={self.author_id!r}, group_id={self.group_id!r}, '
...
class Comment(Base):
    ...
    def __repr__(self) -> str:
        return (
            ...
            f'author_id={self.author_id!r}, post_id={self.post_id!r}, '
...
class Follow(Base):
    ...
    user: Mapped['User'] = relationship(
        back_populates='follower', foreign_keys=[user_id]
    )
    ...
    def __repr__(self) -> str:
        return f'User(user_id={self.user_id!r}, following_id={self.following_id!r})'
